    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        for decoder_layer in self.layers:
            ...
            layer_attention_type = decoder_layer.attention_type
            if layer_attention_type not in causal_mask_mapping:
                layer_attention_type = "full_attention"

            layer_outputs = decoder_layer(
                hidden_states,
                attention_mask=causal_mask_mapping[layer_attention_type],
                position_ids=text_position_ids,
                past_key_values=past_key_values,
                output_attentions=output_attentions,
                use_cache=use_cache,
